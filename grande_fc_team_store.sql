...
-- Colors: Purple / Gold / Black / White  (primary purple #582C83, accent gold #FFB81C).
...
BEGIN
  ...
  INSERT INTO customers (
    ...
    v_rep, true,
    '[]'::jsonb, '[]'::jsonb,
    '[{"hex":"#582C83","code":"268"},{"hex":"#FFB81C","code":"1235"},{"hex":"#000000","code":"Black"},{"hex":"#FFFFFF","code":"White"}]'::jsonb,
