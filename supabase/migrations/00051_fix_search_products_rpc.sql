-- Fix search_products RPC: remove references to non-existent columns (image_url, images, color_category)
-- Add missing color_category column, use image_front_url instead of image_url
...
RETURNS TABLE(
  ...
  is_active BOOLEAN, available_sizes JSONB, _colors JSONB,
