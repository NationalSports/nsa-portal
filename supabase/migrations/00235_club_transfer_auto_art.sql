-- Club transfer auto-art (00235): heat-transfer jobs are born art_complete.
--
...
--
-- Body: create_club_sales_order copied verbatim from 00219 (the live body), with
-- ONLY the v_xfer_ready declaration, its computation, and the birth-state CASEs
-- changed. Rollback: re-apply create_club_sales_order from 00219.
