// Team Shop FAQ content — pure data, no React/DOM, so it's trivially
// testable on its own (see src/__tests__/faqPage.test.js).
//
// IMPORTANT: every answer below is grounded in REAL system behavior (owner
// facts supplied with this task), NOT the approved design mock's placeholder
// numbers/claims. In particular:
...
//     (embroidery | dtf | heat) where 'dtf' is a heat-family variant, not a
//     fourth method.
//   - Support email is the real info@nationalsportsapparel.com — never a
//     fabricated address.
//
// FAQ_CATEGORIES: 'all' plus the 5 category chips from the approved mock.
