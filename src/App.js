...
const D_P=[
{id:'p1',vendor_id:'v1',sku:'JX4453',name:'Adidas Unisex Pregame Tee',brand:'Adidas',color:'Team Power Red/White',category:'Tees',retail_price:55.5,nsa_cost:18.5,available_sizes:['XS','S','M','L','XL','2XL'],is_active:true,_inv:{XS:0,S:12,M:8,L:5,XL:3,'2XL':0},_alerts:{S:20,M:20,L:15,XL:12,'2XL':8}},
...
{id:'EST-2100',customer_id:'c4a',memo:'Test 2: Complex - MD Football Spring Package',status:'draft',created_by:'r1',created_at:'02/18/26 9:00 AM',updated_at:'02/18/26 9:00 AM',default_markup:1.65,shipping_type:'flat',shipping_value:65,ship_to_id:'default',email_status:null,
  art_files:[
    {id:'af_t2a',name:'MD Football Helmet Logo',deco_type:'screen_print',ink_colors:'Cardinal Red\nWhite',thread_colors:'',art_size:'12" x 10"',files:['MD_Helmet_v2.ai'],notes:'2-color front - cardinal red and white',status:'approved',uploaded:'02/17/26'},
    {id:'af_t2b',name:'MD Monarchs Text',deco_type:'screen_print',ink_colors:'Cardinal Red',thread_colors:'',art_size:'4" x 14"',files:['MD_Monarchs_Text.ai'],notes:'1-color back print',status:'approved',uploaded:'02/17/26'},
    {id:'af_t2c',name:'MD Crest',deco_type:'embroidery',ink_colors:'',thread_colors:'Cardinal 200, White, Gold 874',art_size:'3" wide',files:['MD_Crest.dst','MD_Crest.ai'],notes:'8000 stitches, front cap',status:'approved',uploaded:'02/17/26'},
    {id:'af_t2d',name:'MD Lion DTF',deco_type:'dtf',ink_colors:'',thread_colors:'',art_size:'4" Sq & Under',files:['MD_Lion_DTF.png'],notes:'Left leg placement',status:'uploaded',uploaded:'02/18/26'}
  ],
  items:[
    {product_id:'p5',sku:'PC61',name:'Port & Company Essential Tee',brand:'Port & Company',color:'Cardinal',nsa_cost:2.85,retail_price:8.98,unit_sell:4.75,sizes:{S:5,M:10,L:15,XL:8},available_sizes:['S','M','L','XL'],
      decorations:[
        {kind:'art',position:'Front Center',art_file_id:'af_t2a',underbase:false,sell_override:null},
        {kind:'art',position:'Back Center',art_file_id:'af_t2b',underbase:false,sell_override:null},
        {kind:'numbers',position:'Back Center',num_method:'heat_transfer',num_size:'4\"',num_font:'Standard',two_color:false,sell_override:null,roster:{S:['1','3','7','12','15'],M:['2','4','8','10','14','20','22','33','44','55'],L:['5','6','9','11','13','16','17','18','21','23','25','30','32','40','42'],XL:['19','24','26','27','31','34','35','45']}}
      ]},
    {product_id:'p7',sku:'112',name:'Richardson Trucker Cap',brand:'Richardson',color:'Cardinal/White',nsa_cost:4.5,retail_price:12,unit_sell:8,sizes:{OSFA:38},available_sizes:['OSFA'],
      decorations:[{kind:'art',position:'Front Center',art_file_id:'af_t2c',sell_override:null}]},
    {product_id:'p9',sku:'1376844',name:'Under Armour Tech Short',brand:'Under Armour',color:'Cardinal/White',nsa_cost:15.5,retail_price:45,unit_sell:25.5,sizes:{S:5,M:10,L:15,XL:8},available_sizes:['S','M','L','XL'],
      decorations:[{kind:'art',position:'Left Leg',art_file_id:'af_t2d',sell_override:null}]}
  ]},

{id:'EST-2101',customer_id:'c3a',memo:'Test 3: Edge Cases - Badminton Team Uniforms',status:'draft',created_by:'r3',created_at:'02/18/26 10:00 AM',updated_at:'02/18/26 10:00 AM',default_markup:1.50,shipping_type:'pct',shipping_value:10,ship_to_id:'default',email_status:null,
  art_files:[
    {id:'af_t3a',name:'Clovis Badminton Shuttle Logo',deco_type:'screen_print',ink_colors:'Royal Blue\nWhite',thread_colors:'',art_size:'10" x 8"',files:['Clovis_Shuttle.ai'],notes:'2-color shared art for both tees - UNDERBASE NEEDED on dark colors',status:'approved',uploaded:'02/17/26'}
  ],
  items:[
    {product_id:'p11',sku:'N3265',name:'A4 Cooling Performance Tee',brand:'A4',color:'Navy',nsa_cost:5.5,retail_price:18,unit_sell:8.25,sizes:{XS:2,S:6,M:10,L:10,XL:4,'2XL':2,'3XL':1},available_sizes:['XS','S','M','L','XL','2XL','3XL'],
      decorations:[{kind:'art',position:'Front Center',art_file_id:'af_t3a',underbase:true,sell_override:null}]},
    {product_id:'p11',sku:'N3265',name:'A4 Cooling Performance Tee',brand:'A4',color:'White',nsa_cost:5.5,retail_price:18,unit_sell:8.25,sizes:{S:6,M:10,L:10,XL:4},available_sizes:['S','M','L','XL'],
      decorations:[{kind:'art',position:'Front Center',art_file_id:'af_t3a',underbase:false,sell_override:null}]},
    {product_id:null,sku:'CUSTOM',name:'Badminton Birdie Stress Ball',brand:'Custom',vendor_id:'',color:'Yellow/White',nsa_cost:2.5,retail_price:0,unit_sell:8,sizes:{OSFA:35},available_sizes:['OSFA'],is_custom:true,decorations:[]}
  ]},
];
const D_SO=[
...
{id:'SO-1060',customer_id:'c4a',estimate_id:'EST-2100',memo:'Test 2 SO: MD Football Spring Package',status:'in_production',created_by:'r1',created_at:'02/18/26 11:00 AM',updated_at:'02/18/26',expected_date:'03/20/26',production_notes:'Spring practice starts 3/18 - RUSH',shipping_type:'flat',shipping_value:65,ship_to_id:'default',
  firm_dates:[{item_desc:'PC61 Tees - Screen Print',date:'03/10/26',approved:true},{item_desc:'Richardson Caps - Embroidery',date:'03/12/26',approved:false},{item_desc:'UA Shorts - DTF',date:'03/14/26',approved:false}],
  art_files:[
    {id:'af_t2a',name:'MD Football Helmet Logo',deco_type:'screen_print',ink_colors:'Cardinal Red\nWhite',thread_colors:'',art_size:'12\" x 10\"',files:['MD_Helmet_v2.ai'],notes:'2-color front',status:'approved',uploaded:'02/17/26'},
    {id:'af_t2b',name:'MD Monarchs Text',deco_type:'screen_print',ink_colors:'Cardinal Red',thread_colors:'',art_size:'4\" x 14\"',files:['MD_Monarchs_Text.ai'],notes:'1-color back',status:'approved',uploaded:'02/17/26'},
    {id:'af_t2c',name:'MD Crest',deco_type:'embroidery',ink_colors:'',thread_colors:'Cardinal 200, White, Gold 874',art_size:'3\" wide',files:['MD_Crest.dst','MD_Crest.ai'],notes:'8000 stitches',status:'approved',uploaded:'02/17/26'},
    {id:'af_t2d',name:'MD Lion DTF',deco_type:'dtf',ink_colors:'',thread_colors:'',art_size:'4\" Sq & Under',files:['MD_Lion_DTF.png'],notes:'Left leg',status:'uploaded',uploaded:'02/18/26'}
  ],
  items:[
    {sku:'PC61',name:'Port & Company Essential Tee',brand:'Port & Company',color:'Cardinal',nsa_cost:2.85,retail_price:8.98,unit_sell:4.75,sizes:{S:5,M:10,L:15,XL:8},available_sizes:['S','M','L','XL'],
      pick_lines:[{S:5,M:10,L:10,XL:5,status:'pulled'}],
      po_lines:[{po_id:'PO-3010',S:0,M:0,L:5,XL:3,status:'waiting'}],
      decorations:[
        {kind:'art',position:'Front Center',art_file_id:'af_t2a',underbase:false,sell_override:null},
        {kind:'art',position:'Back Center',art_file_id:'af_t2b',underbase:false,sell_override:null},
        {kind:'numbers',position:'Back Center',num_method:'heat_transfer',num_size:'4\"',num_font:'Standard',two_color:false,sell_override:null,roster:{S:['1','3','7','12','15'],M:['2','4','8','10','14','20','22','33','44','55'],L:['5','6','9','11','13','16','17','18','21','23','25','30','32','40','42'],XL:['19','24','26','27','31','34','35','45']}}
      ]},
    {sku:'112',name:'Richardson Trucker Cap',brand:'Richardson',color:'Cardinal/White',nsa_cost:4.5,retail_price:12,unit_sell:8,sizes:{OSFA:38},available_sizes:['OSFA'],
      pick_lines:[{OSFA:38,status:'pick'}],
      po_lines:[],
      decorations:[{kind:'art',position:'Front Center',art_file_id:'af_t2c',sell_override:null}]},
    {sku:'1376844',name:'Under Armour Tech Short',brand:'Under Armour',color:'Cardinal/White',nsa_cost:15.5,retail_price:45,unit_sell:25.5,sizes:{S:5,M:10,L:15,XL:8},available_sizes:['S','M','L','XL'],
      pick_lines:[],
      po_lines:[{po_id:'PO-3011',S:5,M:10,L:15,XL:8,status:'pending'}],
      decorations:[{kind:'art',position:'Left Leg',art_file_id:'af_t2d',sell_override:null}]}
  ]},
];
const D_MSG=[
...
{id:'m8',so_id:'SO-1060',author_id:'r1',text:'Coach Rollinson approved the helmet logo proof. Moving to production on the tees.',ts:'02/18/26 11:30 AM',read_by:['r1']},
{id:'m9',so_id:'SO-1060',author_id:'r3',text:'Warehouse: PC61 tees picked and ready. 30 caps in stock, pulling now. Shorts need full PO from UA.',ts:'02/18/26 12:15 PM',read_by:[]},
{id:'m10',so_id:'SO-1060',author_id:'r2',text:'PO-3010 placed with S&S for remaining 5L + 3XL tees. ETA 3/5. PO-3011 placed with UA for all shorts. ETA 3/8.',ts:'02/18/26 1:00 PM',read_by:[]},
];
...
function OrderEditor({order,mode,customer:ic,allCustomers,products,onSave,onBack,onConvertSO,cu,nf,msgs,onMsg}){
  ...
  const[tab,setTab]=useState('items');const[dirty,setDirty]=useState(false);
    ...
    const markDirty=()=>setDirty(true);const[saved,setSaved]=useState(!!order.customer_id);const[showSend,setShowSend]=useState(false);const[showEstPrint,setShowEstPrint]=useState(false);const[showInvoice,setShowInvoice]=useState(false);const[showPick,setShowPick]=useState(false);const[pickId]=useState(()=>'IF-'+String(4000+Math.floor(Math.random()*1000)));const[showPO,setShowPO]=useState(null);
  ...
  return(<div>
    ...
    <div className="card" style={{marginBottom:16}}><div style={{padding:'16px 20px'}}>
      ...
      <div style={{display:'flex',gap:8,marginTop:12,alignItems:'end',flexWrap:'wrap'}}>
        ...
        {isE&&saved&&<button className="btn btn-secondary" onClick={()=>setShowEstPrint(true)}><Icon name="grid" size={14}/> Print</button>}
      ...
      {isSO&&<div style={{display:'flex',gap:6,marginTop:8}}>
        ...
        <button className="btn btn-secondary" onClick={()=>setShowInvoice(true)}><Icon name="users" size={14}/> Invoice</button>
      </div>}
      {/* SHIPPING */}
    ...
    {showPO&&(()=>{
      ...
      return<div className="modal-overlay" onClick={()=>setShowPO(null)}><div className="modal" onClick={e=>e.stopPropagation()} style={{maxWidth:800,maxHeight:'90vh',overflow:'auto'}}>
        ...
        {showEstPrint&&<div className="modal-overlay" onClick={()=>setShowEstPrint(false)}><div className="modal" onClick={e=>e.stopPropagation()} style={{maxWidth:750,maxHeight:'90vh',overflow:'auto'}}>
      <div className="modal-header"><h2>Estimate Preview</h2><button className="modal-close" onClick={()=>setShowEstPrint(false)}>x</button></div>
      <div className="modal-body" id="est-print">
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:16}}>
          <div><div style={{fontSize:22,fontWeight:800}}>NATIONAL SPORTS APPAREL</div><div style={{fontSize:12,color:'#64748b'}}>Custom Team Apparel & Decoration</div><div style={{fontSize:11,color:'#64748b'}}>Orange, CA | nationalsportsapparel.com</div></div>
          <div style={{textAlign:'right'}}><div style={{fontSize:20,fontWeight:800,color:'#1e40af'}}>{o.id}</div><div style={{fontSize:12,color:'#64748b'}}>Estimate</div><div style={{fontSize:12,color:'#64748b'}}>{new Date().toLocaleDateString()}</div></div></div>
        <hr style={{border:'2px solid #1e3a5f',marginBottom:16}}/>
        <div style={{display:'flex',gap:40,marginBottom:16}}>
          <div><div style={{fontSize:10,fontWeight:700,color:'#64748b',textTransform:'uppercase'}}>Prepared For</div><div style={{fontWeight:700,fontSize:15}}>{cust?.name}</div>{cust?.contacts?.[0]&&<div style={{fontSize:12,color:'#475569'}}>{cust.contacts[0].name} — {cust.contacts[0].role}</div>}{cust?.contacts?.[0]?.email&&<div style={{fontSize:12,color:'#475569'}}>{cust.contacts[0].email}</div>}</div>
          <div><div style={{fontSize:10,fontWeight:700,color:'#64748b',textTransform:'uppercase'}}>Prepared By</div><div style={{fontWeight:700,fontSize:15}}>Steve Peterson</div><div style={{fontSize:12,color:'#475569'}}>National Sports Apparel</div></div>
        </div>
        {o.memo&&<div style={{padding:'8px 12px',background:'#f8fafc',borderRadius:4,marginBottom:16,fontSize:13,border:'1px solid #e2e8f0'}}><strong>RE:</strong> {o.memo}</div>}
        {o.items.map((item,vi)=>{const q=Object.values(item.sizes).reduce((a,v)=>a+v,0);const szList=Object.entries(item.sizes).filter(([,v])=>v>0).sort((a,b)=>(SZ_ORD.indexOf(a[0])===-1?99:SZ_ORD.indexOf(a[0]))-(SZ_ORD.indexOf(b[0])===-1?99:SZ_ORD.indexOf(b[0])));
          const iR=q*item.unit_sell;const decoTotal=item.decorations.reduce((acc,d)=>{const dp=dP(d,q,af);return acc+q*dp.sell},0);
          return<div key={vi} style={{padding:14,border:'1px solid #e2e8f0',borderRadius:8,marginBottom:12}}>
            <div style={{display:'flex',justifyContent:'space-between',marginBottom:8}}>
              <div><span style={{fontWeight:800,fontSize:15}}>{item.name}</span><span style={{fontSize:12,color:'#64748b',marginLeft:8}}>{item.color}</span></div>
              <div style={{textAlign:'right'}}><div style={{fontSize:13}}>Qty: <strong>{q}</strong></div><div style={{fontSize:13}}>${item.unit_sell.toFixed(2)}/ea</div></div></div>
            <table style={{width:'100%',fontSize:11,borderCollapse:'collapse',marginBottom:8}}><thead><tr style={{borderBottom:'1px solid #e2e8f0'}}>{szList.map(([sz])=><th key={sz} style={{padding:'3px 6px',textAlign:'center',color:'#64748b'}}>{sz}</th>)}<th style={{padding:'3px 6px',color:'#64748b'}}>Total</th><th style={{padding:'3px 6px',textAlign:'right',color:'#64748b'}}>Line Total</th></tr></thead>
            <tbody><tr>{szList.map(([sz,v])=><td key={sz} style={{padding:'3px 6px',textAlign:'center',fontWeight:700}}>{v}</td>)}<td style={{padding:'3px 6px',textAlign:'center',fontWeight:800}}>{q}</td><td style={{padding:'3px 6px',textAlign:'right',fontWeight:700}}>${iR.toFixed(2)}</td></tr></tbody></table>
            {item.decorations.map((d,di)=>{const dp=dP(d,q,af);const art=d.kind==='art'?af.find(a=>a.id===d.art_file_id):null;
              return<div key={di} style={{fontSize:12,padding:'4px 8px',background:'#f8fafc',borderRadius:4,marginBottom:4,display:'flex',justifyContent:'space-between'}}>
                <span>{d.kind==='art'?(art?.name||'Art')+' — '+(art?.deco_type||'')+' @ '+d.position:'Numbers — '+d.num_method+' '+d.num_size+' @ '+d.position}{d.underbase?' [Underbase]':''}</span>
                <span style={{fontWeight:600}}>${dp.sell.toFixed(2)}/ea × {q} = ${(dp.sell*q).toFixed(2)}</span></div>})}
            <div style={{textAlign:'right',fontWeight:800,fontSize:14,marginTop:6}}>Item Total: ${(iR+decoTotal).toFixed(2)}</div>
          </div>})}
        <div style={{borderTop:'2px solid #1e3a5f',paddingTop:12,marginTop:8}}>
          <div style={{display:'flex',justifyContent:'space-between',fontSize:14}}><span>Subtotal</span><strong>${fin.rev.toFixed(2)}</strong></div>
          {fin.ship>0&&<div style={{display:'flex',justifyContent:'space-between',fontSize:13,color:'#475569'}}><span>Shipping</span><span>${fin.ship.toFixed(2)}</span></div>}
          {fin.tax>0&&<div style={{display:'flex',justifyContent:'space-between',fontSize:13,color:'#475569'}}><span>Tax</span><span>${fin.tax.toFixed(2)}</span></div>}
          <div style={{display:'flex',justifyContent:'space-between',fontSize:18,fontWeight:800,marginTop:6,padding:'8px 0',borderTop:'1px solid #e2e8f0'}}><span>Estimate Total</span><span style={{color:'#1e40af'}}>${fin.grand.toFixed(2)}</span></div>
        </div>
        <div style={{marginTop:16,padding:12,background:'#f0fdf4',borderRadius:6,fontSize:12,color:'#166534'}}>This estimate is valid for 30 days. Pricing subject to change based on final art approval and quantities. 50% deposit required to begin production.</div>
      </div>
      <div className="modal-footer"><button className="btn btn-secondary" onClick={()=>setShowEstPrint(false)}>Close</button><button className="btn btn-primary" onClick={()=>window.print()}>🖨️ Print</button></div>
    </div></div>}

        {showInvoice&&<div className="modal-overlay" onClick={()=>setShowInvoice(false)}><div className="modal" onClick={e=>e.stopPropagation()} style={{maxWidth:750,maxHeight:'90vh',overflow:'auto'}}>
      <div className="modal-header"><h2>Invoice — {o.id}</h2><button className="modal-close" onClick={()=>setShowInvoice(false)}>x</button></div>
      <div className="modal-body">
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:16}}>
          <div><div style={{fontSize:22,fontWeight:800}}>NATIONAL SPORTS APPAREL</div><div style={{fontSize:12,color:'#64748b'}}>Custom Team Apparel & Decoration</div><div style={{fontSize:11,color:'#64748b'}}>2222 N Santiago Blvd, Orange, CA</div></div>
          <div style={{textAlign:'right'}}><div style={{fontSize:11,fontWeight:700,color:'#64748b'}}>INVOICE</div><div style={{fontSize:20,fontWeight:800,color:'#1e40af'}}>{o.id}</div><div style={{fontSize:12,color:'#64748b'}}>{new Date().toLocaleDateString()}</div></div></div>
        <hr style={{border:'2px solid #1e3a5f',marginBottom:16}}/>
        <div style={{display:'flex',gap:40,marginBottom:16}}>
          <div style={{flex:1}}><div style={{fontSize:10,fontWeight:700,color:'#64748b',textTransform:'uppercase'}}>Bill To</div><div style={{fontWeight:700}}>{cust?.name}</div>{cust?.contacts?.[0]&&<div style={{fontSize:12,color:'#475569'}}>{cust.contacts[0].name}</div>}{cust?.contacts?.[0]?.email&&<div style={{fontSize:12,color:'#475569'}}>{cust.contacts[0].email}</div>}</div>
          <div style={{flex:1}}><div style={{fontSize:10,fontWeight:700,color:'#64748b',textTransform:'uppercase'}}>Ship To</div><div style={{fontSize:12}}>{addrs.find(a=>a.id===o.ship_to_id)?.label||'Default address'}</div></div>
          <div><div style={{fontSize:10,fontWeight:700,color:'#64748b',textTransform:'uppercase'}}>Terms</div><div style={{fontSize:12}}>Net 30</div><div style={{fontSize:10,fontWeight:700,color:'#64748b',textTransform:'uppercase',marginTop:8}}>PO #</div><div style={{fontSize:12}}>{o.memo||'—'}</div></div>
        </div>
        <table style={{width:'100%',fontSize:12,borderCollapse:'collapse',marginBottom:16}}>
          <thead><tr style={{background:'#1e3a5f'}}><th style={{padding:'8px 10px',textAlign:'left',color:'white',fontWeight:700}}>Item</th><th style={{padding:'8px 10px',textAlign:'center',color:'white',fontWeight:700}}>Sizes</th><th style={{padding:'8px 10px',textAlign:'center',color:'white',fontWeight:700}}>Qty</th><th style={{padding:'8px 10px',textAlign:'right',color:'white',fontWeight:700}}>Unit</th><th style={{padding:'8px 10px',textAlign:'right',color:'white',fontWeight:700}}>Total</th></tr></thead>
          <tbody>{o.items.map((item,vi)=>{const q=Object.values(item.sizes).reduce((a,v)=>a+v,0);const szStr=Object.entries(item.sizes).filter(([,v])=>v>0).sort((a,b)=>(SZ_ORD.indexOf(a[0])===-1?99:SZ_ORD.indexOf(a[0]))-(SZ_ORD.indexOf(b[0])===-1?99:SZ_ORD.indexOf(b[0]))).map(([s,v])=>s+':'+v).join(' ');
            const rows=[];rows.push(<tr key={vi+'p'} style={{borderBottom:'1px solid #e2e8f0'}}><td style={{padding:'6px 10px'}}><strong>{item.name}</strong><br/><span style={{fontSize:10,color:'#64748b'}}>{item.sku} — {item.color}</span></td><td style={{padding:'6px 10px',textAlign:'center',fontSize:10}}>{szStr}</td><td style={{padding:'6px 10px',textAlign:'center',fontWeight:700}}>{q}</td><td style={{padding:'6px 10px',textAlign:'right'}}>${item.unit_sell.toFixed(2)}</td><td style={{padding:'6px 10px',textAlign:'right',fontWeight:700}}>${(q*item.unit_sell).toFixed(2)}</td></tr>);
            item.decorations.forEach((d,di)=>{const dp=dP(d,q,af);const art=d.kind==='art'?af.find(a=>a.id===d.art_file_id):null;const label=d.kind==='art'?(art?.name||'Decoration')+' ('+d.position+')':(d.num_method||'Numbers')+' ('+d.position+')';
              rows.push(<tr key={vi+'d'+di} style={{borderBottom:'1px solid #f1f5f9',background:'#f8fafc'}}><td style={{padding:'4px 10px',paddingLeft:30,fontSize:11,color:'#475569'}}>{label}{d.underbase?' +UB':''}</td><td></td><td style={{padding:'4px 10px',textAlign:'center',fontSize:11}}>{q}</td><td style={{padding:'4px 10px',textAlign:'right',fontSize:11}}>${dp.sell.toFixed(2)}</td><td style={{padding:'4px 10px',textAlign:'right',fontSize:11,fontWeight:600}}>${(dp.sell*q).toFixed(2)}</td></tr>)});
            return rows})}</tbody>
        </table>
        <div style={{display:'flex',justifyContent:'flex-end'}}>
          <div style={{width:250}}>
            <div style={{display:'flex',justifyContent:'space-between',padding:'4px 0',fontSize:13}}><span>Subtotal</span><span>${fin.rev.toFixed(2)}</span></div>
            <div style={{display:'flex',justifyContent:'space-between',padding:'4px 0',fontSize:13}}><span>Shipping</span><span>${fin.ship.toFixed(2)}</span></div>
            <div style={{display:'flex',justifyContent:'space-between',padding:'4px 0',fontSize:13}}><span>Tax</span><span>${fin.tax.toFixed(2)}</span></div>
            <div style={{display:'flex',justifyContent:'space-between',padding:'8px 0',fontSize:18,fontWeight:800,borderTop:'2px solid #1e3a5f',marginTop:4}}><span>Total Due</span><span style={{color:'#1e40af'}}>${fin.grand.toFixed(2)}</span></div>
          </div>
        </div>
        <div style={{marginTop:24,padding:12,background:'#f8fafc',borderRadius:6,fontSize:11,color:'#64748b'}}>
          <strong>Payment Terms:</strong> Net 30 days from invoice date. Please make checks payable to National Sports Apparel. For questions regarding this invoice, contact Steve Peterson at steve@nationalsportsapparel.com.
        </div>
      </div>
      <div className="modal-footer"><button className="btn btn-secondary" onClick={()=>setShowInvoice(false)}>Close</button><button className="btn btn-primary" onClick={()=>window.print()}>🖨️ Print</button></div>
    </div></div>}
