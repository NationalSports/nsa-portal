...
import { isDecoOutsourced, outsourcedDecoTypes, decoConcreteType, decoIsOutsourced, garmentNeedsUnderbase } from './businessLogicClient';
...
export const calcOrderTotals=(o,custTaxRate=0)=>{
  ...
  const taxRate=o.tax_exempt||o.promo_applied?0:(o.source==='webstore'?_sNum(o.tax_rate):_sNum(o.tax_rate||custTaxRate));
