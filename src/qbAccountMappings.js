...
export const QB_ACCOUNT_POSTING_MATRIX = Object.freeze([
  ...
  { itemType: 'In-house decoration labor', accountKey: 'decoration_account', account: '55200 Decoration Labor', posting: 'Reference only — not posted', control: 'Accounting confirmed Connect does not post daily labor' },
  { itemType: 'In-house art labor', accountKey: 'in_house_art_account', account: '55400 In House Art', posting: 'Reference only — not posted', control: 'Accounting confirmed Connect does not post daily labor' },
