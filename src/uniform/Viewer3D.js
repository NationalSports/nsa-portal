...
function decalTextCanvas(el) {
  ...
  const opts = { value: val, font: el.font, size: S, fill, outline, outlineWidth: ow, outline2, outline2Width: ow2, letterSpacing: el.letterSpacing || 0, arch: el.arch || 0, italic: !!el.italic };
