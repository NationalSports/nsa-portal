...
test('label carries player, store, bag N of M, contents, and the scan QR', () => {
  ...
  expect(html).not.toContain('class="num"'); // big jersey-number header dropped by request
  expect(html).toContain('<span class="pnum">#23</span>'); // number rides on the jersey LINE instead
