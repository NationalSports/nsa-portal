...
export const cloudUpload=(file,folder='nsa-products')=>_cloudPost(file,folder,false);
export const fileUpload=(file,folder='nsa-art-files')=>_cloudPost(file,folder,true);
